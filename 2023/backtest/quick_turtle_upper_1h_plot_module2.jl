...
function log_maker(days, All_ohlcv, ticker_list, param ,weight)
    ...
    for day in days:-1:1
        ...
        # Threads.@threads for (idx::Int64, ticker) in enumerate(ticker_list)
        ...
        # for ticker in ticker_list
            ...
            #try
                ...
                #println("entry_price = $(entry_price)", "high = $(ohlcv[end][3])")
                #readline()
...
for i=6:40
    for j in range(1, 10, length=15)
        ...
        for k in range(1,24)
            ...
            # log_maker(960+i, All_ohlcvs[k], ticker_lists[k], 18, 2.1)
        end
