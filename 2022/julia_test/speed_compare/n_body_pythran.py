...
# pythran export combinations(float list)
def combinations(l):
    result = []
...
##ppythran export advance(int, float list, list tuple tuple)
...
##ppythran export report_energy(float list, list tuple tuple, float)
...
##ppythran export offset_momentum(str, float list, float, float, float)
