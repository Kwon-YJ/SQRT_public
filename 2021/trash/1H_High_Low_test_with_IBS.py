        ...
        while 1:
            try:
                ...
                if (result[0][1] > 1.5 and result[1][1] > 1) or (
                    ...
                    # if (result[0][1] > 1.5 and result[1][1] > 1.5):
                    # if (result[1][1] > 2.2): # long
                    # if (result[0][1] > 2.2):
                    # if 1 > 0:
                    long_ = All_ohlcv[Down_index[0]]
                    short_ = All_ohlcv[Up_index[0]]
                    # a = 100 * ((short_[-1-hour_][1] / short_[-1-hour_][4]) * 0.99925 * 0.99925 - 1)
                    # b = 100 * ((long_[-1-hour_][1] / long_[-1-hour_][4]) * 0.99925 * 0.99925 - 1)
                    a = 100 * (
                        (short_[-1 - hour_][1] / short_[-1 - hour_][4])
                        * 0.99925
                        * 0.99925
                        - 1
                    )
