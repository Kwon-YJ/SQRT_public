...
def reset():
    ...
    binance = ccxt.binance(
        {
            "apiKey": "gI0RavzErbCCvpBJoDgUHnlYj6kWI0xQT8vSU18KseHLJxUS1i5hSiydInIIpHUF",
            "secret": "RcrClpNWDbfchsW2mRftB4TgD1P7Fm9rs9YtdIYrMA0XKyei8jLMYeoi9tAfxjOD",
    ...
    for i in range(len(tickers)):
        try:
            ...
            if (
                ...
                unit = (today_money / now_current_p) * 0.8
