...
def get_data(day, ticker):
    ...
    for i in range(len(ohlcv_1h)):
        data_ = (ohlcv_1h[-i][1] - low) / (high - low)
        # temp.append(data_)
...
plt.savefig('51-100.png', dpi=300)
...
plt.savefig('101-150.png', dpi=300)
...
plt.savefig('151-200.png', dpi=300)
...
plt.savefig('201-250.png', dpi=300)
...
plt.savefig('251-300.png', dpi=300)
