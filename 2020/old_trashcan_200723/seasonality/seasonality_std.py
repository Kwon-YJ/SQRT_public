...
def get_data(day, ticker):
    ...
    # trade_1 = (ohlcv_1h[2][4] / ohlcv_1h[0][4]) * 0.99964 * 0.99964 - 1
    # trade_2 = (ohlcv_1h[2][4] / ohlcv_1h[5][4]) * 0.99964 * 0.99964 - 1
    temp = (ohlcv_1h[2][1] / ohlcv_1h[7][4]) * 0.99964 * 0.99964 - 1

    # trade_1 = round(-100 + ohlcv_1h[2][4] / ohlcv_1h[0][4] * 99.964 * 99.964, 5)

    # trade_2 = round(-100 + ohlcv_1h[2][4] / ohlcv_1h[5][4] * 99.964 * 99.964, 5)

    result.append(100 * temp)
    # result.append(100 * trade_2)
    # print(earning)
